...
const getCriteriasDescription = (criterias: Criteria[]) => criterias.map(criteria =>
    '{panel:title=""' + criteria.title.replaceAll('"', '""') + '""}\n' +
...
const getCsvExport: (story: UserStory) => string = (story) => {
    const headerLine = 'Project Key,Project Name,Type,Summary,Description,Business Value,Estimation,ROI,DIET,DIET,DIET,DIET'
